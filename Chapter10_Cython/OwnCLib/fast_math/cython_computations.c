...
{
    "distutils": {
        "name": "fast_math.cython_computations",
        "sources": [
            "./fast_math/cython_computations.pyx"
        ]
    },
    "module_name": "fast_math.cython_computations"
}
END: Cython Metadata */
...
#define __PYX_HAVE__fast_math__cython_computations
#define __PYX_HAVE_API__fast_math__cython_computations
/* Early includes */
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
/* Module declarations from 'fast_math.cython_computations' */
...
/* Implementation of 'fast_math.cython_computations' */
...
static const char __pyx_k_min_value_must_be_max_value[] = "min_value must be <= max_value";
static const char __pyx_k_unable_to_allocate_array_data[] = "unable to allocate array data.";
static const char __pyx_k_strided_and_direct_or_indirect[] = "<strided and direct or indirect>";
static const char __pyx_k_input_and_output_arrays_must_be[] = "input and output arrays must be the same size";
...
static PyObject *__pyx_kp_s_input_and_output_arrays_must_be;
...
static PyObject *__pyx_kp_s_min_value_must_be_max_value;
 ...
 */
    __pyx_t_2 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple_, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 7, __pyx_L1_error)
 ...
 */
  ...
  /* "fast_math/cython_computations.pyx":8
 *     if min_value > max_value:
 *         raise ValueError("min_value must be <= max_value")
 *     if a.shape[0] != out.shape[0]:             # <<<<<<<<<<<<<<
 *         raise ValueError("input and output arrays must be the same size")
 ...
 */
  ...
  if (unlikely(__pyx_t_1)) {
    ...
    /* "fast_math/cython_computations.pyx":9
 *         raise ValueError("min_value must be <= max_value")
 *     if a.shape[0] != out.shape[0]:
 *         raise ValueError("input and output arrays must be the same size")             # <<<<<<<<<<<<<<
 *     for i in range(a.shape[0]):
 ...
 */
  ...
  /* "fast_math/cython_computations.pyx":10
 *     if a.shape[0] != out.shape[0]:
 *         raise ValueError("input and output arrays must be the same size")
 *     for i in range(a.shape[0]):             # <<<<<<<<<<<<<<
 *         out[i] = (a[i] if a[i] < max_value else max_value) if a[i] > min_value else min_value
 */
  ...
  for (__pyx_t_5 = 0; __pyx_t_5 < __pyx_t_4; __pyx_t_5+=1) {
    ...
    /* "fast_math/cython_computations.pyx":11
 *         raise ValueError("input and output arrays must be the same size")
 *     for i in range(a.shape[0]):
 *         out[i] = (a[i] if a[i] < max_value else max_value) if a[i] > min_value else min_value             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  __Pyx_AddTraceback("fast_math.cython_computations.cython_clip", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
static PyObject *__pyx_pw_9fast_math_19cython_computations_1cython_clip(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("cython_clip (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_a,&__pyx_n_s_min_value,&__pyx_n_s_max_value,&__pyx_n_s_out,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_min_value)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("cython_clip", 1, 4, 4, 1); __PYX_ERR(0, 5, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_max_value)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("cython_clip", 1, 4, 4, 2); __PYX_ERR(0, 5, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_out)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("cython_clip", 1, 4, 4, 3); __PYX_ERR(0, 5, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "cython_clip") < 0)) __PYX_ERR(0, 5, __pyx_L3_error)
      }
    ...
    __pyx_v_min_value = __Pyx_PyInt_As_long(values[1]); if (unlikely((__pyx_v_min_value == (long)-1) && PyErr_Occurred())) __PYX_ERR(0, 5, __pyx_L3_error)
    __pyx_v_max_value = __Pyx_PyInt_As_long(values[2]); if (unlikely((__pyx_v_max_value == (long)-1) && PyErr_Occurred())) __PYX_ERR(0, 5, __pyx_L3_error)
  ...
  __pyx_r = __pyx_pf_9fast_math_19cython_computations_cython_clip(__pyx_self, __pyx_v_a, __pyx_v_min_value, __pyx_v_max_value, __pyx_v_out);
...
static PyObject *__pyx_pf_9fast_math_19cython_computations_cython_clip(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_a, long __pyx_v_min_value, long __pyx_v_max_value, __Pyx_memviewslice __pyx_v_out) {
  ...
  if (unlikely(!__pyx_v_a.memview)) { __Pyx_RaiseUnboundLocalError("a"); __PYX_ERR(0, 5, __pyx_L1_error) }
  if (unlikely(!__pyx_v_out.memview)) { __Pyx_RaiseUnboundLocalError("out"); __PYX_ERR(0, 5, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_9fast_math_19cython_computations_cython_clip(__pyx_v_a, __pyx_v_min_value, __pyx_v_max_value, __pyx_v_out, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 5, __pyx_L1_error)
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "fast_math.cython_computations.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "fast_math.cython_computations.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "fast_math.cython_computations.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "fast_math.cython_computations._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"cython_clip", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_9fast_math_19cython_computations_1cython_clip, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_cython_computations(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_cython_computations},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_input_and_output_arrays_must_be, __pyx_k_input_and_output_arrays_must_be, sizeof(__pyx_k_input_and_output_arrays_must_be), 0, 0, 1, 0},
  ...
  {&__pyx_kp_s_min_value_must_be_max_value, __pyx_k_min_value_must_be_max_value, sizeof(__pyx_k_min_value_must_be_max_value), 0, 0, 1, 0},
 ...
 *         raise ValueError("input and output arrays must be the same size")
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_kp_s_min_value_must_be_max_value); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 7, __pyx_L1_error)
 ...
 *         out[i] = (a[i] if a[i] < max_value else max_value) if a[i] > min_value else min_value
 */
  __pyx_tuple__2 = PyTuple_Pack(1, __pyx_kp_s_input_and_output_arrays_must_be); if (unlikely(!__pyx_tuple__2)) __PYX_ERR(0, 9, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initcython_computations(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initcython_computations(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_cython_computations(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_cython_computations(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_cython_computations(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'cython_computations' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_cython_computations(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("cython_computations", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_fast_math__cython_computations) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "fast_math.cython_computations")) {
      if (unlikely(PyDict_SetItemString(modules, "fast_math.cython_computations", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "fast_math/cython_computations.pyx":1
 * cimport cython             # <<<<<<<<<<<<<<
 * 
 * @cython.boundscheck(False)
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init fast_math.cython_computations", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init fast_math.cython_computations");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
